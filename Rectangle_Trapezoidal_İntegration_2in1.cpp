...
int main() {
    ...
    cout << setw(10) << "Intervals" << setw(9) << "Trapez"  << setw(11) << "TrueError" << setw(12) << " RelError(%)"  << setw(10) << "Intervals" << setw(10) << " Rectangle"  << setw(11) << "TrueError" << setw(14) << "RelError(%)" << endl;
	...
	for (i=1; i <=ntimes; i=i+1) {
        ...
        cout << setw(10) << n << setw(9) << trap << setw(10) << trueError << setw(12) << RelError<< setw(10) << n << setw(10) << rect << setw(10) << trueErrorRect << setw(12) << RelErrorRect << endl;
